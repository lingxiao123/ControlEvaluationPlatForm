<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="Policy_Add.aspx.cs" Inherits="PlatFormWeb.Office.Policy_Add" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                ...
                <f:FormRow>
                    <Items>
                        <f:HtmlEditor runat="server" Label="制度内容" ID="HtmlEditor1" Height="300px">
                        </f:HtmlEditor>
                    </Items>
                </f:FormRow>
            </Rows>
