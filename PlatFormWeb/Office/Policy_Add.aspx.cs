...
{
    public partial class Policy_Add :PageBase
    {
        ...
        protected void btnSaveRefresh_Click(object sender, EventArgs e)
        {
            ...
            string sql = string.Format("insert into Policy(Name,Theme,Content,Status,AuthorName,AddTime,Remark) values('{0}','{1}','{2}',{3},'{4}','{5}','{6}')", name, theme, content, 1, Session["UserName"], DateTime.Now, txtRemark.Text.Trim());
