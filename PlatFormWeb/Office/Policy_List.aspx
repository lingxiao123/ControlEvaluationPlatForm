<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Policy_List.aspx.cs" Inherits="PlatFormWeb.Office.Policy_List" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" Width="100%" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Grid ID="Grid1" Width="100%" Title="政策制度" PageSize="20" ShowBorder="true" ShowHeader="true"
                        ...
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Window ID="Window2" IconUrl="~/res/images/16/10.png" runat="server" Hidden="true"
                                    WindowPosition="Center" IsModal="true" Title="政策制度" EnableMaximize="true"
                                    EnableResize="true" Target="Self" EnableIFrame="true"
                                    Height="500px" Width="650px">
                                </f:Window>
                            </Items>
                    ...
                    <Columns>
                        <f:RowNumberField />
                        <f:BoundField ID="Name" DataField="Name" HeaderText="制度名称"></f:BoundField>
                        <f:BoundField ID="Theme" DataField="Theme" HeaderText="制度主题"></f:BoundField>
                        ...
                        <f:WindowField TextAlign="Center" Width="80px" HeaderText="操作" WindowID="Window4"
                            ToolTip="详情" Text="详情" DataIFrameUrlFields="Id" DataIFrameUrlFormatString="~/Office/Policy_Edit.aspx?Id={0}"
                            Title="详情" />
                    </Columns>
                </f:Grid>
            </Items>
