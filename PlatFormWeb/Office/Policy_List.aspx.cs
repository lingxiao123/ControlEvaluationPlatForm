...
{
    public partial class Policy_List :PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                btnAdd.OnClientClick = Window1.GetShowReference("~/Office/Policy_Add.aspx", "", 800, 500);
                LoadData();
            }
        }
        ...
        {
            string sql = string.Format("select Id,Name,Theme,case Status when '1' then '已发布' end as Status,AuthorName,AddTime,Remark from Policy");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "delete from Policy where Id in(" + ids + ")";
