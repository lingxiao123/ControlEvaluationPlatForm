<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkNotice_Edit.aspx.cs" Inherits="PlatFormWeb.Office.WorkNotice_Edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                ...
                <f:FormRow>
                    <Items>                     
                        <f:HtmlEditor runat="server" Label="通知内容" ID="HtmlEditor1" Height="500px">
                        </f:HtmlEditor>
                    </Items>
                </f:FormRow>
            </Rows>
