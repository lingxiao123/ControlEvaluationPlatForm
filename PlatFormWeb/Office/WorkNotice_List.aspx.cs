...
{
    public partial class WorkNotice_List :PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                btnAdd.OnClientClick = Window1.GetShowReference("~/Office/WorkNotice_Add.aspx","",800,500);
                LoadData();
            }
        }
        ...
        {
            string sql = string.Format("select Id,NoticeName,NoticeTheme,Status,AuthorCode,AuthorName,AddTime,Remark from WorkNotice");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "delete from WorkNotice where Id in(" + ids + ")";
